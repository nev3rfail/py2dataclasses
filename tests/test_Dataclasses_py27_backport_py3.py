...
def patch_test(target_module):
    ...
    target_module.dataclasses = py2dataclasses
...
def load_tests(loader, tests, pattern):
    ...
    sys.modules["dataclasses"] = py2dataclasses
    from .test_Dataclasses_py27 import common
...
if __name__ == '__main__':
    ...
    root_suite = loader.discover("tests.test_Dataclasses_py27", top_level_dir=os.getcwd())
